...
from .analysis.cointegration import CointegrationAnalyzer, quick_cointegration_analysis
...
def run_cointegration_analysis(
    ...
    print(f"✅ Data retrieved: {price_data.shape[0]} observations, {price_data.shape[1]} symbols")
            ...
            if not PLOTTING_AVAILABLE:
                ...
                try:
                    ...
                    if save_plots:
                        ...
                        # Plot time series
                        fig1 = plot_time_series(price_data, normalize=True, 
                                              title="Normalized Price Series")
                        
                        # Plot cointegrated pairs
                        fig2 = plot_cointegrated_pairs(results, price_data, max_pairs=4)
