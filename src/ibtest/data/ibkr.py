...
class IBKRDataSource:
    ...
    def connect(self) -> bool:
        ...
        print(
            f"STUB: Host: {self.host}, Port: {self.port}, Client ID: {self.client_id}"
        )
    ...
    def fetch_historical_data(
        ...
        """
        print(
            f"STUB: Would fetch {duration} of {bar_size} {what_to_show} data for {symbol}"
        )
...
def create_mock_stock_data(
    ...
    for symbol in symbols:
        ...
        # Create OHLCV data
        df_data = []
        for _i, (timestamp, price) in enumerate(zip(date_range, prices)):
