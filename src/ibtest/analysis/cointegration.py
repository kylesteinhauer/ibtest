...
class CointegrationResult:
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"CointegrationResult({self.symbol1}-{self.symbol2}: "
...
class CointegrationAnalyzer:
    ...
    def analyze_pairs(
        self, price_data: pd.DataFrame, min_observations: int = 50
    ...
    def filter_cointegrated_pairs(
        ...
        cointegrated = [result for result in results if result.p_value < threshold]
    ...
    def create_summary_report(
        self, results: List[CointegrationResult], include_all: bool = False
    ) -> pd.DataFrame:
        """
    ...
    def get_spread_statistics(self, result: CointegrationResult) -> Dict[str, float]:
        """
    ...
    def print_results(
        ...
        for result in display_results:
            ...
            print(
                f"{result.symbol1}-{result.symbol2:<15} "
